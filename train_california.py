...
## main
  ...
  if(train_model):
    ...
    if (pruning):
      ...
      time_stamp = str(datetime.now())
      results_simple.to_csv(path_result + "Pruning_california_simple_" +time_stamp+ ".csv")
      results_complex.to_csv(path_result + "Pruning_california_complex_new_"+time_stamp+".csv")
    if (quantize):
      criterion = nn.MSELoss()
      path_result = "data/results/"
      ...
      time_stamp = str(datetime.now())
      results_simple.to_csv(path_result + "california_simple_" +time_stamp+ ".csv")
      results_complex.to_csv(path_result + "california_complex_new_"+time_stamp+".csv")
